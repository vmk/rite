...
import io.github.vmk.rite.exceptions.RiteRuntimeException;
import io.github.vmk.rite.operations.Recipe;
import io.github.vmk.rite.persistence.RecipeStore;
import io.github.vmk.rite.persistence.TimeStamp;
...
public class MongoRecipeStore implements RecipeStore {
    ...
    private boolean collectionExists(final String collectionName, Set<String> collectionNames) {
		for (final String name : collectionNames) {
			System.out.println("collectionExists :: " + name + " tested against: " + collectionName);
